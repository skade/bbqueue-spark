...
alr build
gnatbind -n ./lib/bbqueue ./lib/bbqueue-buffers ./lib/bbqueue-buffers-ffi ./alire/cache/dependencies/atomic_0.4.1_14bb7db3/lib/atomic

# this is broken, as I don't know how to build the har
